...
public class ACE {
    ...
    /** Logger */
    private static final Logger log = LogManager.getLogger(ACE.class);
    ...
    /**
     * Creates a new ACE object from the given String
     *
     * @param aceDefinition a single entry of the acl definition string
     * @return the ACE object, or null if the definition could not be parsed
     */
     ...
     * @param granteeID user or group UUID, or the sentinel for any grantee
     */
     ...
     * @return true if this entry decides the given action for the given user
     */
