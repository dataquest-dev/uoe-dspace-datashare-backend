...
public class UserCheck extends Check {
    ...
    public String run(ReportInfo ri) {
        ...
        try {
            ...
            // NOTE: The "subscribed collections" metric (CollectionService#findCollectionsWithSubscribers)
            // relies on the legacy subscription model where a Subscription pointed directly at a Collection.
            // In this DSpace version subscriptions target a generic DSpaceObject, so that query does not
            // resolve and, once executed, poisons the shared Hibernate session (aborting the whole report).
            // It is therefore intentionally not reported here.
